...
.body(function() {
  ...
  Player = game.Class.extend({
    ...
    init: function() {
      ...
      this.sprite = new game.MovieClip([
        game.Texture.fromImage(MEDIA_PATH + 'media/coin1.png'),
        game.Texture.fromImage(MEDIA_PATH + 'media/coin2.png'),
        game.Texture.fromImage(MEDIA_PATH + 'media/coin3.png')
      ]);
      ...
      var shape = new game.Rectangle(80+4, 80-4-8);
      ...
      this.smokeEmitter.textures.push(MEDIA_PATH + 'media/particle.png');
      ...
      this.flyEmitter.textures.push(MEDIA_PATH + 'media/particle2.png');
  ...
  Gap = game.Class.extend({
    ...
    init: function() {
      ...
      this.topSprite = new game.Sprite(game.system.width + this.width / 2, topHeight, MEDIA_PATH + 'media/bar.png', {
        anchor: {x: 0.5, y: 0.0},
        scale: {y: -1}
      });
      game.scene.gapContainer.addChild(this.topSprite);

      this.bottomSprite = new game.Sprite(game.system.width + this.width / 2, topHeight + this.height, MEDIA_PATH + 'media/bar.png', {
        anchor: {x: 0.5, y: 0.0},
      });
  ...
  Logo = game.Class.extend({
    init: function() {
      ...
      var sprite;
      sprite = new game.Sprite(game.system.width / 2, 0, MEDIA_PATH + 'media/logo1.png', {anchor: {x:0.5, y:0.5}});
      ...
      // sprite = new game.Sprite(game.system.width / 2, 80, MEDIA_PATH + 'media/logo2.png', {anchor: {x:0.5, y:0.5}});
      // this.container.addChild(sprite);

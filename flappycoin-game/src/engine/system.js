    ...
    **/
    ...
    init: function(width, height, canvasId) {
        ...
        if(!document.getElementById(this.canvasId)) {
            ...
            if (game.System.canvasContainerId) {
              document.getElementById(game.System.canvasContainerId).appendChild(canvas);
            } else {
    ...
    **/
    ...
    initResize: function() {
        ...
        if(game.device.mobile) {
            ...
            if (game.System.position) {
              this.canvas.style.position = game.System.position;
            }
